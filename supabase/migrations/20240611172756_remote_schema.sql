...
CREATE POLICY "Allow authenticated users to CRUD" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "allow authenticated user to CRUD" ON "public"."order_items" USING (true) WITH CHECK (true);

CREATE POLICY "allow authenticated users to CRUD" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
